...
def configurar_coordenadas():
    ...
    # Ajuste os tempos de espera (sleeps) conforme o lag do seu PC
    time_sleeps = ['3', '2', '4', '2', '2', '2', '1', '1', '1', '1']
    ...
    passos = [
        ...
        "Clique no botão de Pegar 15 Baús automaticamente",
        "Clique em OK/Continuar na tela de recompensas",
    ...
    print(f"Coordenadas enxutas salvas em {caminho_arquivo}")