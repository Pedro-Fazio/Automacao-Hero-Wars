...
def _coletar_mensagem(coord_x, coord_y, tempo):
    # Clica na mensagem [4] e fica esperando o botão Coletar [5] ficar verde
    FS.clicar_e_aguardar_proximo(
        coord_x[4], coord_y[4], tempo[4],
        coord_x[5], coord_y[5], (71, 164, 30),
