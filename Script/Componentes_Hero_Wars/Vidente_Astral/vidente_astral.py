...
def completar_uma_vez(coord_x, coord_y, tempo):
    ...
    # Clica em Asgard
    FS.clicar_e_aguardar_proximo(coord_x[1], coord_y[1], tempo[1], 2710, 840, (165, 148, 167), offset_x=0, offset_y=0)

    # Clica no Vidente Astral
    FS.clicar_e_aguardar_proximo(coord_x[2], coord_y[2], tempo[2], 3040, 910, (62, 172, 36), offset_x=0, offset_y=0)
